...
public class L94BinaryTreeInOrderTraversal extends BaseObject {
    ...
    /*
    sol 2. iterative
    root is the top element in the stack, use a helper node to store the next "visiting" node and subtree
